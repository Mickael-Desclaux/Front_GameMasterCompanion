...
import { character } from "@/fakeData/data";
...
export default function CharacterResume() {
	return (
		<>
			<h3 className="text-center font-bold text-2xl mb-2 -mt-2">
				{character.characterName}
			</h3>
			<h4 className="text-center underline text-xl mb-4">
				{character.characterClass} {character.characterRace} - Niveau{" "}
			...
			<div className="flex flex-col lg:flex-row flex-wrap">
				...
				<div className="flex flex-col justify-center lg:justify-evenly lg:w-2/3 m-2 lg:m-0">
					<div className="grid lg:grid-cols-4 grid-cols-2 lg:content-evenly gap-2 m-1 justify-center items-center lg:justify-evenly">
						<StatBlock
							label="PV"
							children={`${character.characterCurrentHealth} / ${character.characterMaxHealth}`}
						/>
						<StatBlock
							label="Initiative"
							children={
						...
						<StatBlock
							label="Inspirations"
							children={character.characterInspirations}
						/>
					</div>
			...
			<div className="flex flex-col lg:flex-row lg:justify-evenly mt-4">
				<ListDisplay
					label="Résistances"
					dataList={character.characterDefenses}
				/>
				<ListDisplay
					label="Vulnérabilités"
					dataList={character.characterVulnerabilities}
				/>
				<ListDisplay
					label="Immunités"
					dataList={character.characterImmunities}
				/>
				<ListDisplay
					label="Langues"
					dataList={character.characterLanguages}
				/>
			</div>
		</>
	);
