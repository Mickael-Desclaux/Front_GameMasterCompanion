...
export const lastNote: LastNote = {
	...
	description:
		"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas posuere metus quis erat lacinia, " +
...
export const lastSpell: SpellResume = {
	...
	description:
		"Une éclatante traînée lumineuse est émise de la pointe de votre doigt vers un point de votre choix " +
...
export const lastNPC = {
	...
	description:
		"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi volutpat elit ut tincidunt " +
...
export const campaignData = {
	...
	title: "Descente en Avernes",
	description:
		"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris lectus turpis, fringilla sit amet " +
	...
	chapters: [
		{
			...
			description:
				"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris lectus turpis, fringilla " +
	...
	characters: [
		{
			characterId: 1,
			characterIcon: "https://docs.material-tailwind.com/img/face-2.jpg",
			characterName: "Jean-Christophain de la table basse",
			characterClass: "Magicien",
			characterRace: "Haut-Elfe",
			characterSpeed: 9,
			characterLevel: 2,
			...
			characterSkillsProficiencies: ["ARCANA", "HISTORY", "INVESTIGATION"],
			characterDefenses: ["Sommeil magique"],
			characterVulnerabilities: ["Physique"],
			characterImmunities: [],
			characterLanguages: ["Commun", "Elfe", "Draconique"],
		},
		{
			characterId: 2,
			characterIcon: "https://docs.material-tailwind.com/img/face-1.jpg",
			characterName: "Annick",
			characterClass: "Druide",
			characterRace: "Elfe des bois",
			characterSpeed: 9,
			characterLevel: 2,
			characterCurrentHealth: 2,
			characterMaxHealth: 30,
			characterInitiative: 2,
			characterArmor: 14,
			characterInspirations: 0,
			characterStats: {
				strength: 10,
				dexterity: 14,
				constitution: 14,
			...
			characterStatsProficiencies: ["WISDOM", "CONSTITUTION"],
			characterSkillsProficiencies: [
				"ANIMAL_HANDLING",
				"NATURE",
				"MEDICINE",
				"SURVIVAL",
			],
			characterDefenses: ["Poison"],
			characterVulnerabilities: ["Feu"],
			characterImmunities: [],
			characterLanguages: ["Commun", "Elfe", "Sylvain"],
		},
		{
			characterId: 3,
			characterIcon: "https://docs.material-tailwind.com/img/face-3.jpg",
			characterName: "Jean-Pierre",
			characterClass: "Barde",
			characterRace: "Tieffelin",
			characterSpeed: 9,
			characterLevel: 2,
			characterCurrentHealth: 8,
			characterMaxHealth: 12,
			characterInitiative: 4,
			characterArmor: 13,
			characterInspirations: 2,
			characterStats: {
				strength: 9,
				dexterity: 16,
				constitution: 12,
			...
			characterStatsProficiencies: ["DEXTERITY", "CHARISMA"],
			characterSkillsProficiencies: [
				"PERFORMANCE",
				"PERSUASION",
				"STEALTH",
			...
			characterDefenses: ["Feu"],
			characterVulnerabilities: [],
			characterImmunities: ["Charme"],
			characterLanguages: ["Commun", "Infernal", "Elfe"],
		},
		{
			characterId: 4,
			characterIcon: "https://docs.material-tailwind.com/img/face-4.jpg",
			characterName: "Richard McGlutan",
			characterClass: "Barbare",
			characterRace: "Demi-Elfe",
			characterSpeed: 9,
			characterLevel: 2,
			characterCurrentHealth: 21,
			characterMaxHealth: 30,
			...
			characterStatsProficiencies: ["STRENGTH", "CONSTITUTION"],
			characterSkillsProficiencies: ["ATHLETICS", "INTIMIDATION", "SURVIVAL"],
			characterDefenses: ["Froid"],
			characterVulnerabilities: ["Psychique"],
			characterImmunities: [],
			characterLanguages: ["Commun", "Elfe"],
		},
	],
